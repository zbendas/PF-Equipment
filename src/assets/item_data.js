/**
 * @module ItemData
 * @desc Isolate file used to compartmentalize item information.
 */
/**
 ...
 * @property {string} item_type - Item category. This will usually be one of the following: Unarmed, Light, One-handed,
 * Two-handed, Ranged, or Ammunition
 * @property {string} [classification] - Simple, Martial, Exotic, etc; Optional where item_type = "Ammunition"
 * @property {string} name - Item name, as listed in PRD or other reference documentation.
 * @property {string} [alt_name] - Alternate version of name, if applicable. E.g., "Flail, heavy" and "Heavy flail"
 * @property {string} [cost] - Item cost, as listed. E.g., "2 sp", "10 gp"
 * @property {number} [amount] - Amount of item purchasable per cost
 ...
 * @property {number|number[]} [critical_multiplier] - Critical damage multiplier
 ...
 * In cases where weight is "special", this property can be supplied as a string.
...
/**
 * @desc Exported data set of all items in the application.
 * @type {ItemObject[]}
 */
let ItemDataSet = [];
/**
 * @desc Internal item set containing all items sourced from the Pathfinder Core Rulebook.
 * @type {ItemObject[]}
 * @protected
 */
let CoreRulebookSet = [
...
/**
 * @desc Internal item set containing all items sourced from Pathfinder Ultimate Equipment.
 * @type {ItemObject[]}
 * @protected
 */
